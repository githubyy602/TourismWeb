...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("代澳旗", "https://yangywt.top/联系人访问链接", "339452689@163.com");
        return new ApiInfo(
                "Swagger学习", // 标题
                "学习演示如何配置Swagger", // 描述
                "v1.0", // 版本
                "https://yangy.top/组织链接", // 组织链接
                contact, // 联系人信息
                "Apach 2.0 许可", // 许可
                "许可链接", // 许可连接
                new ArrayList<>()// 扩展
    ...
    public Docket docket(Environment environment) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yangy.web.controller"))//根据这个包生成接口文档
                .build();
    }
}
